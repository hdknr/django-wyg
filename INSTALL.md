# **django-wyg** Installation Instructions

This section contains information about 
how to download and install **django-wyg ** in your system. 
...
inside the ** django-wyg ** distribution package. 
...
URL is https://github.org/hdknr/django-wyg


## Install

To install **django-wyg** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.org/hdknr/django-wyg

The above command will install the latest development release of **django-wyg**.
